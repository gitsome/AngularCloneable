(function () {
    ...
    angular.isClonable = function (item) {
    ...
    angular.module('AngularCloneable').factory('Cloneable', [
        ...
        function () {
            ...
            var Cloneable = function () {
                ...
                var reinstantiateClonableItems = function (item) {

                    if (angular.isClonable(item)) {
                        ...
                        angular.forEach(item, function (arrayItem, arrayIndex) {
                            item[arrayIndex] = reinstantiateClonableItems(arrayItem);
                        });

                    } else if (angular.isObject(item)) {

                        angular.forEach(item, function (itemValue, itemKey) {
                            item[itemKey] = reinstantiateClonableItems(itemValue);
                        });
